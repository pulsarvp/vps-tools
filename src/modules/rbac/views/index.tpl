<ul class="nav nav-tabs" role="tablist">
	...
	<li><a href="#premission" role="tab" data-toggle="tab">{Yii::tr('Premissions', [], 'rbac')}</a></li>
</ul>
<div class="tab-content">
		...
		<table class="table table-hover table-striped" id="user-list">
			<thead>
				<tr>
					...
					<th></th>
					<th class="no-sort">{Yii::tr('Role', [], 'rbac')}</th>
				</tr>
			</thead>
			<tbody>
	...
	<div role="tabpanel" class="tab-pane" id="premission">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				{$f->field($roleForm, 'childPermissions')->select($permissions, [ 'value' => 'name', 'label' => 'name' ], [ 'class' => 'selectpicker', 'multiple' => true, 'title' => Yii::tr('Select premissions', [], 'rbac'),'id'=>'childPermissions' ])}
